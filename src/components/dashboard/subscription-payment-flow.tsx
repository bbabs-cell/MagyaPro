 ...
 * que de basculer instantanément — c'est le Super Admin qui valide la
 * réception avant que le nouveau plan ne s'applique. Les plans gratuits
 * restent un changement immédiat, sans paiement à faire.
 */
