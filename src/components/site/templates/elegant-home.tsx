    ...
    <>
      ...
      {sections.length > 1 && (
        <nav
          ...
          className="sticky top-16 z-10 flex justify-center gap-6 overflow-x-auto border-b border-surface-border bg-surface/30 px-4 py-3 backdrop-blur-2xl backdrop-saturate-150"
        >
