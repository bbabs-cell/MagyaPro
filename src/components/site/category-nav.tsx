...
export function CategoryNav({
  ...
  return (
    <nav
      ...
      className="sticky top-16 z-30 -mx-4 mt-5 border-b border-surface-border bg-surface/65 px-4 py-2 backdrop-blur-lg sm:mx-0 sm:rounded-xl sm:border sm:px-3"
    >
