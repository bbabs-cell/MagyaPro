...
export const AUDIT_ACTIONS = {
  ...
  STORE_WEBHOOK_CREATED: 'store_webhook.created',
  STORE_WEBHOOK_DELETED: 'store_webhook.deleted',
  ...
  SUPPLIER_PAYMENT_CREATED: 'supplier_payment.created',
  ...
  STORE_PROMOTION_CREATED: 'store_promotion.created',
  STORE_PROMOTION_UPDATED: 'store_promotion.updated',
  STORE_PROMOTION_DELETED: 'store_promotion.deleted',
} as const;
