...
export function StoreRegisterForm({ turnstileSiteKey }: { turnstileSiteKey: string | null }) {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const result = await api.post<{ redirectTo: string }>('/api/boutique/auth/register', {
